...
def arg_parse():
    ...
    parser.add_argument("-t", "--theme", choices=["AkameGaKill", "CyborgGruvbox", "Everblush", "Graphite", "HackTheBox", "SamuraiGirl", "SweetDark", "XXE"], help="specify an Athena theme to be set [AkameGaKill|CyborgGruvbox|Everblush|Graphite|HackTheBox|SamuraiGirl|SweetDark|XXE]")
...
def help():
   ...
   print("-t, --theme <theme-name>      specify an Athena theme to be set [AkameGaKill|CyborgGruvbox|Everblush|Graphite|HackTheBox|SamuraiGirl|SweetDark|XXE]")
   print("\n")
...
if args.emulator:
    ...
    for i in terminal_map:
        ...
        if chosen_emulator == terminal_bin:
            ...
            subprocess.call("find /usr/share/applications -type f -name '*.desktop' -exec sed -i -e 's/alacritty -e/"+terminal_bin+" "+terminal_arg_cmd+"/g' -e 's/cool-retro-term -e/"+terminal_bin+" "+terminal_arg_cmd+"/g' -e 's/foot -e/"+terminal_bin+" "+terminal_arg_cmd+"/g' -e 's/gnome-terminal --/"+terminal_bin+" "+terminal_arg_cmd+"/g' -e 's/kitty -e/"+terminal_bin+" "+terminal_arg_cmd+"/g' -e 's/konsole -e/"+terminal_bin+" "+terminal_arg_cmd+"/g' -e 's/urxvt -e/"+terminal_bin+" "+terminal_arg_cmd+"/g' -e 's/xterm -e/"+terminal_bin+" "+terminal_arg_cmd+"/g' {} +", shell=True)
