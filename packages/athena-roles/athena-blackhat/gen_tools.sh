...
to_exclude=("apkid" "python-yara-rednaga" "ssma" "mobsf" "quickscope" "argus-clients" "qt3" "xplico" "pyqt3" "qscintilla-qt3" "faradaysec" "gerix-wifi-cracker" "inguma" "braces" "facebrok" "pfff" "fuzzdb" "smartphone-pentest-framework" "trape")
