...
to_exclude=("seclists" "argus-clients" "xplico" "faradaysec" "inguma" "fuzzdb" "smartphone-pentest-framework" "trape" "binflow" "fastnetmon" "vpnpivot" "wolpertinger" "ncpfs" "sigploit")
