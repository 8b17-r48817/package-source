...
("Malware Analyst", "binflow", "POSIX function tracing. Much better and faster than ftrace."),
...
("Malware Analyst", "radare2-keystone", "Keystone assembler plugins for radare2."),
...
("Mobile Analyst", "radare2-keystone", "Keystone assembler plugins for radare2."),
...
("Mobile Analyst", "sigploit", "Telecom Signaling Exploitation Framework - SS7, GTP, Diameter & SIP."),
...
("Network Analyst", "fastnetmon", "High performance DoS/DDoS load analyzer built on top of multiple packet capture engines."),
...
("Network Analyst", "ncpfs", "Allows you to mount volumes of NetWare servers under Linux."),
...
("Network Analyst", "proxybroker", "Proxy [Finder | Checker | Server]. HTTP(S) & SOCKS."),
...
("Network Analyst", "sagan", "A snort-like log analysis engine."),
...
("Network Analyst", "snmp-brute", "SNMP brute force, enumeration, CISCO config downloader and password cracking script."),
...
("Network Analyst", "udp2raw-tunnel", "An Encrypted, Anti-Replay, Multiplexed UdP Tunnel, tunnels udp traffic through fake-tcp or icmp by using raw socket"),
...
("Network Analyst", "vpnpivot", "Explore the network using this tool."),
...
("OSINT Specialist", "vpnpivot", "Explore the network using this tool."),
...
("Red Teamer", "binflow", "POSIX function tracing. Much better and faster than ftrace."),
...
("Red Teamer", "fastnetmon", "High performance DoS/DDoS load analyzer built on top of multiple packet capture engines."),
...
("Red Teamer", "ncpfs", "Allows you to mount volumes of NetWare servers under Linux."),
...
("Red Teamer", "proxybroker", "Proxy [Finder | Checker | Server]. HTTP(S) & SOCKS."),
...
("Red Teamer", "sigploit", "Telecom Signaling Exploitation Framework - SS7, GTP, Diameter & SIP."),
...
("Red Teamer", "ssh-audit", "SSH server and client configuration auditing"),
...
("Red Teamer", "tfsec", "Security scanner for your Terraform code."),
...
("Red Teamer", "udp2raw-tunnel", "An Encrypted, Anti-Replay, Multiplexed UdP Tunnel, tunnels udp traffic through fake-tcp or icmp by using raw socket"),
...
("Red Teamer", "vpnpivot", "Explore the network using this tool."),
...
("Red Teamer", "wolpertinger", "A distributed portscanner."),
